...
/*
 * This is a base tracer used by both the server side and browser tracer.
 * It should remain platform independent.
 */
export abstract class BaseAutoblocksTracer {
  ...
  protected readonly cliServerAddress: string | undefined;
  ...
  protected mergeProperties(args?: SendEventArgs) {
  ...
  protected async sendEventUnsafe(
    message: string,
    args?: SendEventArgs,
  ): Promise<undefined> {
  ...
  abstract sendEvent(message: string, args?: SendEventArgs): Promise<undefined>;
}
