...
> {
  ...
  constructor(args: {
    ...
    this.appId = APP_NAME_TO_ID[args.appName];
    this.id = args.id;
  ...
  exec<T = unknown>(
    fn: (args: {
      prompt: PromptExecutionContextV2<
        (typeof APP_NAME_TO_ID)[AppName],
        PromptId,
        MajorVersion
      >;
    }) => T,
    ...
    const ctx = new PromptExecutionContextV2<
      (typeof APP_NAME_TO_ID)[AppName],
      PromptId,
      MajorVersion
    >(prompt);
