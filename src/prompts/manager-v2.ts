...
export class AutoblocksPromptManagerV2<
  AppId extends __Autogenerated__AppId,
  PromptId extends __Autogenerated__PromptIdV2<AppId>,
  MajorVersion extends __Autogenerated__PromptMajorVersionV2<AppId, PromptId>,
...
> {
  ...
  private get logger() {
    const prefix = `[${this.appId}/${this.id}@v${this.majorVersion}]`;
    return {
  ...
  exec<T = unknown>(
    fn: (args: {
      prompt: PromptExecutionContextV2<AppId, PromptId, MajorVersion>;
    }) => T,
  ): T {
    const prompt = this.chooseExecutionPrompt();
    if (!prompt) {
      throw new Error(
        `[${this.appId}/${this.id}@${this.majorVersion}] Failed to choose execution prompt. Did you initialize the prompt manager?`,
      );
    }
    ...
    const ctx = new PromptExecutionContextV2<AppId, PromptId, MajorVersion>(
      prompt,
    );
...
> {
  ...
  get params(): __Autogenerated__PromptParamsV2<AppId, PromptId, MajorVersion> {
